...
%>
<form method="POST" action='MemberHandler' name="frmEditUser"><input
...
<table>
	...
	<tr>
		<td>UserName</td>
		<td><input type="text" name="m_username" value="<%=member.getM_username()%>"/></td>
	</tr>
	<tr>
		<td>Password</td>
		<td><input type="text" name="m_password" value="<%=member.getM_password()%>"/></td>
	</tr>
	<tr>
		<td></td>
